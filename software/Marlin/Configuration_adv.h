...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define PROBE_OFFSET_WIZARD      // Eff // Add a Probe Z Offset calibration option to the LCD menu
...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.6 } // Eff     // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
    #define ADVANCE_K 0.6     // Eff     // (mm) Compression length applying to all extruders
  #endif
