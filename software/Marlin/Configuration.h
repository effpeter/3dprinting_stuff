...
#define STRING_CONFIG_H_AUTHOR "(eff917, Ender-3)" // Who made the changes.
#define DIAG_JUMPERS_REMOVED // Eff
...
#define CUSTOM_MACHINE_NAME "Ender-3abl" // Eff
 ...
 */
//#define PIDTEMP // Eff          // See the PID Tuning Guide at https://reprap.org/wiki/PID_Tuning
#define MPCTEMP  // Eff       // ** EXPERIMENTAL ** See https://marlinfw.org/docs/features/model_predictive_control.html
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 14.77f }           // Eff     // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.1635f }        // Eff     // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.1254f }           // Eff     // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.1313f } // Eff      // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
 ...
 */
#define PIDTEMPBED // Eff

#if ENABLED(PIDTEMPBED)
  //#define MIN_BED_POWER 0
  //#define PID_BED_DEBUG // Print Bed PID debug data to the serial port.

  #define DEFAULT_bedKp 121.39 // Eff
  #define DEFAULT_bedKi 21.68  // Eff
  #define DEFAULT_bedKd 453.18 // Eff
...
#define Z_MIN_ENDSTOP_HIT_STATE LOW // Eff
...
#define Z_MIN_PROBE_ENDSTOP_HIT_STATE LOW // Eff
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 95.25 } // Eff
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 5, 150 } // Eff
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 500, 100, 5000 } // Eff
 ...
 */
#define DEFAULT_ACCELERATION                   1000 // Eff // X, Y, Z ... and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION           500         // E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION            1000 // Eff // X, Y, Z ... acceleration for travel (non printing) moves
 ...
 */
// #define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN // Eff

// Force the use of the probe for Z-axis homing 
#define USE_PROBE_FOR_Z_HOMING // Eff (because of multiple build plates)
 ...
 */
//#define Z_MIN_PROBE_PIN PC14 // Eff
...
#define BIQU_MICROPROBE_V2  // Eff // Triggers LOW
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -10, -2 } // Eff
 ...
 */
#define PROBE_ENABLE_DISABLE // Eff
 ...
 */
#define FILAMENT_RUNOUT_SENSOR // Eff
...
#define AUTO_BED_LEVELING_BILINEAR // Eff
//#define AUTO_BED_LEVELING_UBL
//#define MESH_BED_LEVELING // Eff
